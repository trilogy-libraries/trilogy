...
TEST test_build_auth_packet_cleartext()
{
    trilogy_builder_t builder;
    trilogy_buffer_t buff;
...
TEST test_build_auth_packet_cleartext_with_pass()
{
    trilogy_builder_t builder;
    trilogy_buffer_t buff;
    int err = trilogy_buffer_init(&buff, 1);
    ...
    static const uint8_t expected[] = {
        0x3b, 0x00, 0x00, 0x01, 0x00, 0xa2, 0x88, 0x01, 0xff, 0xff, 0xff, 0x00, 0x2d, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x72, 0x6f, 0x6f, 0x74, 0x00, 0x00, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x5f,
        0x63, 0x6c, 0x65, 0x61, 0x72, 0x5f, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x00
    };
...
TEST test_build_auth_cleartext_with_database()
{
    trilogy_builder_t builder;
    trilogy_buffer_t buff;
    int err = trilogy_buffer_init(&buff, 1);
...
TEST test_build_auth_packet_cleartext_with_pass_and_database()
{
    trilogy_builder_t builder;
    trilogy_buffer_t buff;
    int err = trilogy_buffer_init(&buff, 1);
    ...
    static const uint8_t expected[] = {
        0x40, 0x00, 0x00, 0x01, 0x08, 0xa2, 0x88, 0x01, 0xff, 0xff, 0xff, 0x00, 0x2d, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x72, 0x6f, 0x6f, 0x74, 0x00, 0x00, 0x74, 0x65, 0x73, 0x74, 0x00, 0x6d, 0x79, 0x73, 0x71,
        0x6c, 0x5f, 0x63, 0x6c, 0x65, 0x61, 0x72, 0x5f, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x00
    };
